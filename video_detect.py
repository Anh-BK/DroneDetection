...
class YOLO(object):
    _defaults = {
        ...
        #"model_path": 'model_data/yolo_weights_dataset1.h5', #yolov3 tiny
        "anchors_path": 'model_data/drone_yolo_anchors3.txt',
...
if __name__=="__main__":
    ...
    out = cv2.VideoWriter('./Output/output3.mp4', fourcc, 20.0, (width,height))
    if not cap.isOpened():
    ...
    while True:
        ...
        if ret == True:
          ...
          #    fps = int(fps)
          #    fps = str(fps)
          cv2.putText(r_image, fps, (7, 70), font, 3, (100, 255, 0), 3, cv2.LINE_AA)
          #    fps = 0 
          #    start_time = time.time()
